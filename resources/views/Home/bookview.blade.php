			...
			<div class="row" style="margin-top: 20px; margin-bottom: 20px;">
				...
				<div class="col-md-7">
					...
					<table class="table table-bordered">
						...
						@else
						<button onclick="paymentBook({{$book->id}})">Đặt nghe truyện 30 ngày</button>
						@endif
	...
	<script>
		$(function () {
		  ...
		  function paymentBook(id){
		  	swal({
		  		title: "Bạn có chắc muốn mua truyện 30 ngày với 10,000VND?",
    ...
    function(isConfirm) {
    	if (isConfirm) {
    		$.ajax({
    			...
    			{
    				toastr.success('Mua Truyện Thành Công!');
    				location.reload()
    			},
		  ...
		  function paymentToPage(){
		  	swal({
		  		title: "Bạn không đủ tiền để mua truyện bạn có muốn nạp tài khoản ngay không",
        // text: "Bạn sẽ không thể khôi phục lại bản ghi này!!",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#DD6B55",
